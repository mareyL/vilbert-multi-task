...
parser.add_argument(
    "--rep_save_path",
    default="datasets/ME/out_features/zz_train_features.pkl",
    type=str,
    help="The output directory where the textual and visual representations will be written.",
)
...
parser.add_argument(
    "--save_name", default="task-19", type=str, help="save name for training."
)
parser.add_argument(
    "--use_chunk",
    default=0,
...
cPickle.dump(pooled_dict, open(args.rep_save_path, 'wb'))
